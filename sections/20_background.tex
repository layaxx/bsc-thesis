...
A typical process for \ac{CBR} consists of four steps: Case Retrieval, Adaptation, Execution and Evaluation.\cite{Kolodner1992} % TODO: actually 4 probably
...
% explain database, case retrieval (similarity)
% TODO: usual approaches to case representation and application
