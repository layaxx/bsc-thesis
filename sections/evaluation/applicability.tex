...
\asfigure{fig:predicates-by-objects}{data/predicates_by_objects}{Predicates per case and objects per case}{10}
...
\asfigure{fig:one-case}{data/onecase_distribution}{}{10}
