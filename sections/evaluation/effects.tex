...
\asfigure{fig:effects-result}{data/effects_result}{rate of misclassification depends on the number of affected objects, not the total number of objects in the scene (indicated by the size of the points and their label)}{15}
